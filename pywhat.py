...
pywhatkit.sendwhatmsg("phone number", "message", 20,6,True ,3)

# # Same as above but Closes the Tab in 2 Seconds after Sending the Message
# pywhatkit.sendwhatmsg("phone_number", "Hi", 19, 40, 18, True, 2)

# # Send an Image to a Group with the Caption as Hello
# # pywhatkit.sendwhats_image("testgroup", "C:\Users\nandi\.vscode\ascii_art\laptop.jpg", "Hello")

# # Send an Image to a Contact with the no Caption
# # pywhatkit.sendwhats_image("phone_number", "C:\Users\nandi\.vscode\ascii_art\laptop.jpg")
